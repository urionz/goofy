...
var rulesFuncMap = make(map[string]func(DataFace, string, string, string, interface{}) error)
...
func AddCustomRule(name string, fn func(dataFace DataFace, field string, rule string, message string, value interface{}) error) {
	if isRuleExist(name) {
...
func validateCustomRules(field string, rule string, message string, value interface{}, dataFace DataFace, errsBag url.Values) {
	for k, v := range rulesFuncMap {
		if k == rule || strings.HasPrefix(rule, k+":") {
			err := v(dataFace, field, rule, message, value)
			if err != nil {
...
func init() {
	...
	AddCustomRule("required", func(dataFace DataFace, field, rule, message string, value interface{}) error {
	...
	AddCustomRule("regex", func(dataFace DataFace, field, rule, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("alpha", func(dataFace DataFace, field string, vlaue string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("alpha_dash", func(dataFace DataFace, field string, vlaue string, message string, value interface{}) error {
		str := toString(value)
	...
	// AlphaDash check if provided field contains valid letters, numbers, underscore and dash
	AddCustomRule("alpha_space", func(dataFace DataFace, field string, vlaue string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("alpha_num", func(dataFace DataFace, field string, vlaue string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("bool", func(dataFace DataFace, field string, vlaue string, message string, value interface{}) error {
	...
	AddCustomRule("between", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
	...
	AddCustomRule("credit_card", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("coordinate", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("css_color", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("digits", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
	...
	AddCustomRule("digits_between", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
	...
	AddCustomRule("date", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("email", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("float", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("ip", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("ip_v4", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("ip_v6", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("json", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("lat", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("lon", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("len", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
	...
	AddCustomRule("min", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
	...
	AddCustomRule("max", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
	...
	AddCustomRule("mac_address", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	// Numeric check if the value of the field is Numeric
	AddCustomRule("numeric", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("numeric_between", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
	...
	AddCustomRule("url", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
		err := fmt.Errorf("The %s field format is invalid", field)
		if message != "" {
			err = errors.New(message)
	...
	AddCustomRule("uuid", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("uuid_v3", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("uuid_v4", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("uuid_v5", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		str := toString(value)
	...
	AddCustomRule("in", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
	...
	// In check if provided field equals one of the values specified in the rule
	AddCustomRule("not_in", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
	...
	AddCustomRule("required_if", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		var err error
		args := strings.Split(strings.TrimPrefix(rule, "required_if:"), ",")
		if len(args) == 0 {
			panic(errInvalidArgument)
		}
		anotherField, mustEquals := args[0], args[0:]
	...
	AddCustomRule("cn_mobile", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
		...
		str := toString(value)
		err := fmt.Errorf("the %s field must be a valid cn mobile", field)
		if message != "" {
			err = errors.New(message)
		}
		if !isCnMobile(str) {
