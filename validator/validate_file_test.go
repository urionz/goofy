...
func Test_validateFiles_CustomRule(t *testing.T) {
	...
	AddCustomRule("customRule1", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
	...
	isValueNil := false
	AddCustomRule("customRule2", func(dataFace DataFace, field string, rule string, message string, value interface{}) error {
